...
public class Task1_Coverage {
	...
	/*
	 * BEGIN SimpleTemplateEngine
	 */
	
	@Test
	public void SimpleValueNullMatchingMode() 
	{
		String template = "Hi, my name is David. DAVID is my forename.";
		String expected = "Hi, my name is Peter. Peter is my forename.";

		String result = simpleEngine.evaluate(template, "David", "Peter", null);
		assertEquals(result, expected);
	}
	
	@Test
	public void SimpleValueLessThanZeroMatchingMode() 
	{
		String template = "Hi, my name is David. DAVID is my forename.";
		String expected = "Hi, my name is Peter. Peter is my forename.";

		String result = simpleEngine.evaluate(template, "David", "Peter", -1);
		assertEquals(result, expected);
	}
	
	@Test
	public void SimpleValueGreaterThanThreeMatchingMode() 
	{
		String template = "Hi, my name is David. DAVID is my forename.";
		String expected = "Hi, my name is Peter. Peter is my forename.";
